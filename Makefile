...
help:
	...
	@echo "  make run-dev         - Run application in development mode (with logs)"
	...
	@echo "  make test-all-tables - Test all tables batch endpoint"
	...
	@echo "  make test-get        - Test GET endpoints"
	...
	@echo "  make docker/run      - Run Docker image manually"
	@echo "  make docker/test     - Legacy test command"
